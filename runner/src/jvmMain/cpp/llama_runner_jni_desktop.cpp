...
#define LOGI(...) do { fprintf(stderr, "[LlamaRunner] "); fprintf(stderr, __VA_ARGS__); fprintf(stderr, "\n"); } while (0)
#define LOGE(...) do { fprintf(stderr, "[LlamaRunner] "); fprintf(stderr, __VA_ARGS__); fprintf(stderr, "\n"); } while (0)
